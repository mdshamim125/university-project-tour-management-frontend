...
function NavigationMenu({
  ...
  viewport = true,
  ...props
}: React.ComponentProps<typeof Root> & { viewport?: boolean }) {
  return (
    <Root
...
function NavigationMenuList({
  ...
  return (
    <List
      className={cn(
        "flex items-center justify-center list-none gap-1",
        className
      )}
      {...props}
    />
...
function NavigationMenuItem({
  ...
  return <Item className={cn("relative", className)} {...props} />;
}
...
function NavigationMenuViewport({
  ...
  return (
    <div className="absolute left-0 top-full flex justify-center">
      <Viewport className={cn(className)} {...props} />
    </div>
  );
}
...
function NavigationMenuIndicator({
  ...
  return <Indicator className={cn(className)} {...props} />;
}
