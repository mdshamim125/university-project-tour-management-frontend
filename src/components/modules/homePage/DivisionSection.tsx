...
export default function DivisionSection() {
  ...
  return (
    <section className="py-6 md:py-12 bg-gray-50 container mx-auto px-8 md:px-16 dark:bg-gray-900">
      <div className="max-w-7xl mx-auto px-4 text-center">
        ...
        {isFetching ? (
                  ...
                  <CardContent className="p-4">
                    <p className="text-sm text-gray-600 dark:text-gray-300 line-clamp-2">
                      {division.description ||
                        "Explore this region's hidden gems."}
                    </p>
                  </CardContent>
                </Card>
              </Link>
          ...
          <p className="text-gray-500 text-center">No divisions available.</p>
        )}
      </div>
    </section>
  );
